...
const thetaboardMarketplace = [
  ...
  },
  {
    ...
    "name": "fetchPurchasedItemsForAddress",
    "outputs": [
      {
        "components": [
          {
  ...
  },
  {
    ...
    "name": "fetchSellingItemsForAddress",
    "outputs": [
      {
        "components": [
          {
...
const thetaboardOffer = [
  ...
  },
  {
    ...
    "name": "getByNftContractTokenIdAddress",
    "outputs": [
      {
        "components": [
          {
