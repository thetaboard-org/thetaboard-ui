...
export default class TrendTfuelComponent extends Component {
  ...
  get trendYesterday() {
    ...
    const perc_change = this.historicPrice.historicPrice ? this.historicPrice.historicPrice.tfuel.change_24h : 0;
  ...
  get trendLastWeek() {
    ...
    const prices = this.historicPrice.historicPrice ? this.historicPrice.historicPrice.dailyPrice.find((x) => x.date === lastWeek)['tfuel-price'] : 0;
    const tfuelPrice = this.thetaSdk.prices.tfuel.price;
