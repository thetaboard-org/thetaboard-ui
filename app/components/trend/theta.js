...
export default class TrendThetaComponent extends Component {
  ...
  get trendYesterday() {
    ...
    const perc_change = this.historicPrice.historicPrice ? this.historicPrice.historicPrice.theta.change_24h : 0;
  ...
  get trendLastWeek() {
    ...
    const prices = this.historicPrice.historicPrice ? this.historicPrice.historicPrice.dailyPrice.find((x) => x.date === lastWeek)['theta-price'] : 0;
    const thetaPrice = this.thetaSdk.prices.theta.price;
